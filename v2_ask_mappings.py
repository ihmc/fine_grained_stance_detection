...
tomeks_ask_types = {
  "LOSE": [ #verbs may need to be used differently in their passive (victim in subject) vs active form (victim in DO) for this class but not focused on that for now
    ...
    "10.5.p Verbs of Possessional Deprivation : Steal Verbs",
    "10.6.a.p Verbs of Possessional Deprivation : Cheat Verbs / -of",
    "10.6.c.p Verbs of Possessional Deprivation : Cheat Verbs / -out of",
    "17.1 Throw Verbs",
    "17.2.i Pelt Verbs",
    ...
    "31.2.d.p Admire Verbs - Negative / -for/as",
